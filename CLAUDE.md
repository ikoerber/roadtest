...
standardisierten OBD-II-Daten. Aktueller Firmwarestand: **1.5.33**.
...
- Firmware 1.5.33 baut erfolgreich für `lolin_s3_mini`.
- Letzter Build: 71.044 Byte RAM (21,7 %) und 1.219.138 Byte Flash (93,0 %).
