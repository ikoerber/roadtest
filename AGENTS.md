...
standardisierten OBD-II-Daten. Aktueller Firmwarestand: **1.5.46**.
...
- Firmware 1.5.46 baut erfolgreich für `lolin_s3_mini`.
- Letzter Build: 82.076 Byte RAM (25,0 %) und 1.169.042 Byte Flash (89,2 %).
